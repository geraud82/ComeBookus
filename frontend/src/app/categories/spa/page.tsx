    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          // Automatically search for nearby spas
      ...
      <section className="relative bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 pt-20 pb-16">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center text-sm text-gray-600 mb-6">
            ...
            <span className="text-gray-900 font-medium">Spas</span>
          </div>
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Discover the best spas in your area. 
              Facial treatments, body care, massages, and relaxation moments.
            </p>
          </div>
            ...
            <Card className="p-6 shadow-lg">
              ...
              {userLocation && (
                <div className="text-green-600 text-sm mt-2 flex items-center">
                  ...
                  Location detected - Searching for nearby spas
                </div>
              )}
            </Card>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Discover the most requested treatments
            </p>
          </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                {searchResults.length} spa{searchResults.length !== 1 ? 's' : ''} found
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Choose a spa with a relaxing atmosphere and high hygiene standards
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Check therapist qualifications and the quality of products used
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Find an easily accessible spa with convenient hours
              </p>
            </div>
          </div>
        </div>
