...
const serviceCategories = [
  { value: 'HAIR', label: 'Coupe homme' },
  { value: 'EYEBROWS', label: 'Taille barbe' },
  { value: 'MAKEUP', label: 'Rasage' },
  { value: 'WELLNESS', label: 'Soins visage homme' },
];
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          // Recherche automatique des barbiers proches
  ...
  const searchNearbyBusinesses = async (lat?: number, lng?: number) => {
    ...
    try {
      const params = new URLSearchParams({
        ...
        type: 'BARBERSHOP', // Filtrer uniquement les barbiers
        limit: '20'
      });
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50 pt-20 pb-16">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center text-sm text-gray-600 mb-6">
            ...
            <span className="text-gray-900 font-medium">Barbier</span>
          </div>
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Découvrez les meilleurs barbiers dans votre région. 
              Coupe homme, taille de barbe, rasage traditionnel et soins.
            </p>
          </div>
            ...
            <Card className="p-6 shadow-lg">
              ...
              {userLocation && (
                <div className="text-green-600 text-sm mt-2 flex items-center">
                  ...
                  Position détectée - Recherche des barbiers proches
                </div>
              )}
            </Card>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Services populaires chez le barbier
            </h2>
      ...
      {searchResults.length > 0 && (
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Barbiers près de vous
              </h2>
              <p className="text-lg text-gray-600">
                {searchResults.length} barbier{searchResults.length > 1 ? 's' : ''} trouvé{searchResults.length > 1 ? 's' : ''}
              </p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Conseils pour choisir votre barbier
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Choisissez un barbier expérimenté qui maîtrise votre style préféré
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Vérifiez la qualité des outils et les standards d'hygiène du salon
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Privilégiez un barbier avec une bonne ambiance et un service personnalisé
              </p>
            </div>
          </div>
        </div>
